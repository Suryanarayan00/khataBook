...
export {default as ReadBlog} from './ReadBlog/ReadBlog';
...
export {default as CustomerFeedback} from './Main/CustomerFeedback.js/CustomerFeedback';
export {default as Login} from './Login/Login';
export {default as Credit} from './Main/Credit/Credit';
