        ...
        return (
            <WrapperContainer bgColor={colors.lightGreyBg}>
                ...
                <View style={styles.floatingBox}>
                    ...
                    <View style={[commonStyles.inline, {justifyContent: 'space-between'}]}>
                        <Text>$ 0</Text>
                ...
                <View style={styles.payment}>
                    <View style={styles.box}>
                        <TouchableOpacity onPress={() => this.openModal({ isScannerVisible: true })}>
                            ...
                            <Text style={[commonStyles.mediumFont, { color: colors.black }]}>{strings.OPEN_SCANNER}</Text>
                        </TouchableOpacity>
                    </View>
                ...
                <Modal visible={isVisible} >
                    <View style={[commonStyles.center, { flex: 1, width: '100%' }]}>
                        <QRCode
                            size={300}
                        ...
                        />
                        <GradientButton containerStyle={styles.absoluteBottom} btnText={strings.CLOSE} onPress={() => this.closeModal({ isVisible: false })} />
                    </View>
                </Modal>
                    ...
                    <QRCodeScanner
                        ...
                        topContent={
                            <Text style={commonStyles.buttonTextWhite}>
                                Go to{' '}
                                <Text style={commonStyles.mediumFont}>wikipedia.org/wiki/QR_code</Text> on
            your computer and scan the QR code.
          </Text>
                        }
                        bottomContent={
                            <GradientButton containerStyle={styles.absoluteBottom} btnText={strings.CLOSE} onPress={() => this.closeModal({ isScannerVisible: false })} />
                        }
                    />
                </Modal>
            </WrapperContainer>
