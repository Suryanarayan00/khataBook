    ...
    return (
        <WrapperContainer>
            <View style={{ marginTop: moderateScaleVertical(100), flex: 1 }}>
                <Text style={[commonStyles.mediumBoldFont, {color: colors.textGrey}]}>{strings.LOGIN}</Text>
                <View style={{ marginHorizontal: moderateScale(24) }}>
                <Text style={[commonStyles.mediumBoldFont, {fontFamily: fontFamily.futura, color: colors.textGreyB}]}>{strings.WELCOME_NOTE}</Text>
                    <GradientButton
